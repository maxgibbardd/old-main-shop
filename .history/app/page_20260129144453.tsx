  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      ...
      <section className="max-w-6xl mx-auto py-20 px-6 grid md:grid-cols-2 gap-12 items-center">
        <div className="grid grid-cols-2 gap-6 relative group">
          {/* First Image: Stacked - Fixed Aspect Ratio */}
          <div className="relative bg-white p-2 rounded-xl shadow-xl -rotate-2 group-hover:rotate-0 transition duration-500">
          ...
          {/* Second Image: Hanging - Fixed Aspect Ratio */}
          <div className="relative bg-white p-2 rounded-xl shadow-xl rotate-3 group-hover:rotate-0 transition duration-500 mt-12">
            <div className="aspect-[3/4] w-full overflow-hidden rounded-lg bg-slate-100">
               <img 
